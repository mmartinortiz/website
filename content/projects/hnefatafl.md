...
The book describes an entire family of games originating in northern Europe, known as the [Tafl](https://en.wikipedia.org/wiki/Tafl_games) family. These games share similar boards and rules, with variations depending on the region or time period. One such variation is [Hnefatafl](https://en.wikipedia.org/wiki/Tafl_games#Hnefatafl). The mechanics intrigued me, so I created a prototype using the most basic tools: pen and paper. After playing a few rounds with my son, I decided it deserved a wooden version.
